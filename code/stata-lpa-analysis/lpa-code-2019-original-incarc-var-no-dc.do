...
log using log_2019_original_incarc_var_no_dc.log, replace

clear all

use ../../data/cleaned/structural_racism_2019_original_incarceration_var_no_dc.dta
...
save lpa_classes_original_incarceration_var_no_dc.dta, replace
