...
If your intention is to replicate our analysis and you are familiar with github, please clone this repository. All of the data cleaning and data visualization steps are contained within the numerically ordered files in the code > r-data-cleaning-and-visualization folder. The Stata code to conduct the latent profile analysis appears in the code > stata-lpa-analysis folder. All raw data files also can be found in the data > raw folder except for the National Prisoner Statistics (NPS) file. Each individual user must download these data from https://www.icpsr.umich.edu/web/NACJD/studies/38871. 

If you are unfamiliar with github, but familiar with R and RStudio as well as Stata, you may wish to download the analysis files by navigating to the code directory and downloading a ZIP file of the repository. You can download and open the .Rmd files locally within RStudio and the .do file within Stata. You will also need to download the appropriate data files found in the data directory. You can then run the code chunks within RStudio and the run the .do file within Stata to replicate the analysis. 
