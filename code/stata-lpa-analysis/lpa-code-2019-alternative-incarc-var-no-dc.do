...
log using log_2019_alternative_incarc_var_no_dc.log, replace

clear all

use ../../data/cleaned/structural_racism_2019_alt_incarceration_var_no_dc.dta
...
save lpa_classes_alternative_incarceration_var_no_dc.dta, replace
